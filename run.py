...
model = keras_segmentation.models.fcn.fcn_8_vgg(n_classes=2 ,  input_height=416, input_width=608, verify_dataset = False)
# model.load_weights("./tmp/vgg_unet_1.1")

model.train( 
    train_images =  train_images_path,
    train_annotations = train_segs_path,
    checkpoints_path = "./tmp/fcn_fcn_8_vgg" , epochs=2
)
